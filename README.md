...
I was also able to gain a great deal of experience with user testing as I had to conduct multiple user interviews to collect data that would help me to improve upon the app. This also taught me that it can be easy to overlook design flaws in an app when you have been interacting with it for an extensive period of time and it can also be easy to assume that other users will think the same way you do when it comes to interacting with the app and completing certain tasks. 

Overall, this was a highly valuable experience that I was able to take away key skills from. Even if I do not wish to pursue anything in the UX/UI field in the future, I know that regardless of whatever career path I choose, there will be some element of this process that will be useful to me. 
